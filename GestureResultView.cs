...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        private readonly ImageSource trueImage = new BitmapImage(new Uri(@"Images\true.png", UriKind.Relative));

        /// <summary> Image to show when the 'detected' property is false for a tracked body </summary>
        private readonly ImageSource falseImage = new BitmapImage(new Uri(@"Images\false.png", UriKind.Relative));
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence)
        {
            ...
            else
            {
                ...
                if (this.Detected)
                {
                    ...
                    this.ImageSource = this.trueImage;
                }
                else
                {
                    this.ImageSource = this.falseImage;
                }
            }
        }
