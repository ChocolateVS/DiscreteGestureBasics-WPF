...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class KinectBodyView
    {
        ...
        public KinectBodyView(KinectSensor kinectSensor, MainWindow m)
        {
            main = m;
        ...
        public void UpdateBodyFrame(Body[] bodies, ulong id)
        {
            if (bodies != null)
            {
                using (DrawingContext dc = this.drawingGroup.Open())
                {
                    ...
                    foreach (Body body in bodies)
                    {
                        ...
                        if (body.TrackingId == id) drawPen = this.bodyColors[1]; 
                        ...
                        if (body.IsTracked)
                        {
                            ...
                            //Probably need to only do if body id is the active user...
                            if (body.TrackingId == id) main.updateHandState(body.HandLeftState, body.HandRightState, id);
                        }
                    }
